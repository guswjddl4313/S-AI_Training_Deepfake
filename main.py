import os
import shutil
from image_random import Rand_images
from face_detection import Face_masking
from change_background import Inpaint_images
...
if __name__ == '__main__':
    try:
        ...
        ## Inpaint_images
        prompt_file_path = './prompt_dataset.txt' #prompt 데이터 경로
